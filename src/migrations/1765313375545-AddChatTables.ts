...
export class AddChatTables1765313375545 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DROP INDEX "public"."idx_research_results_search_vector"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."idx_research_results_embedding"`,
    );
    await queryRunner.query(
      `CREATE TABLE "messages" ("id" uuid NOT NULL, "conversationId" uuid NOT NULL, "role" character varying(20) NOT NULL, "content" text NOT NULL, "messageOptions" text NOT NULL, "researchLogId" uuid, "citations" text, "tokenCount" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "editedAt" TIMESTAMP, CONSTRAINT "PK_18325f38ae6de43878487eff986" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_e5663ce0c730b2de83445e2fd1" ON "messages" ("conversationId") `,
    );
    await queryRunner.query(
      `CREATE TABLE "conversations" ("id" uuid NOT NULL, "userId" uuid NOT NULL, "title" text NOT NULL, "summary" text, "tokenCount" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_ee34f4f7ced4ec8681f26bf04ef" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_a9b3b5d51da1c75242055338b5" ON "conversations" ("userId") `,
    );
    await queryRunner.query(
      `ALTER TABLE "research_results" DROP COLUMN "search_vector"`,
    );
    await queryRunner.query(
      `ALTER TABLE "research_results" DROP COLUMN "confidence"`,
    );
    await queryRunner.query(
      `ALTER TABLE "research_results" ADD "confidence" text`,
    );
    await queryRunner.query(
      `ALTER TABLE "research_results" DROP COLUMN "embedding"`,
    );
    await queryRunner.query(
      `ALTER TABLE "research_results" ADD "embedding" text`,
    );
    await queryRunner.query(
